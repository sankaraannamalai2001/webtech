...
function getReq(req, res) {
  ...
  const fname = querystring.parse(query)["fname"];
  const lname = querystring.parse(query)["lastname"];
  const rollno = querystring.parse(query)["rollno"];
  const gender = querystring.parse(query)["gender"];
  const dept = querystring.parse(query)["dept"];
  const mobile = querystring.parse(query)["mobile"];
  const yos = querystring.parse(query)["yos"];
  const email = querystring.parse(query)["email"];
  // res.write("first name: " + fname);
  // res.write("Last name: " + lname);
  // res.write("Roll number: " + rollno);
  // res.write("Gender: " + gender);
  // res.write("Department: " + dept);
  // res.write("Phone number: " + mobile);
  // res.write("Year of Study: " + yos);
